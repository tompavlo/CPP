...
int main()
{
    ...
    case 1:
    {
        Worker employees[] = {{"Cleaner", 7, 0.5},{"Nurse", 10, 0.9},{"Physician", 10, 1.1},{"Pharmacy Manager",1,1.0},{"Head of Department", 3, 1.3},{"Chief Physician", 1, 1.5},{"Pharmacy Supervisor", 1, 1.2},{"Hospital Director", 1, 1.5}};
        ...
        for (int i = 0; i < 8; i++)
        {
            salary = (employees[i].employeeID * employees[i].efficiencyFactor / totalEfficiencyFactor) * totalBudget;
    ...
    case 2:
    {
        ...
        case 1:
        {
            distributeByNorthwestCorner(supplies, demands, costs);
            break;
        }
        case 2:
        {
            distributeByMinimumCost(supplies, demands, costs);
            break;
        }
        }
        break;
